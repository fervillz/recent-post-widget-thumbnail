...
Tags: recent posts, thumbnails, widget, widgets, sidebar, excerpt, post status
...
== Description ==
This plugin will empower a custom, adaptable and easy to use recent posts widget, you can show it by means of widget. Permits you to show a list of the latest posts with thumbnail, excerpt and post date.
